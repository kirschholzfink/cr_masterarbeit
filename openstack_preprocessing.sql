...
/*
 Delete all comments that were generated by bots.
*/
delete
from t_history
...
/*
 Delete automatically generated comments.
 */
delete
from t_history
WHERE hist_message LIKE '%Build Started%'
   ...
   or hist_message like '%Build queued%'
   or hist_message like '%Build succeeded%'
   or hist_message like '%Build succeed.%'
   or hist_message like '%SUCCESS%'
   or hist_message like '%FAILURE%'
   or hist_message like '%Workflow+1%'
   or hist_message like
      '%Your patch will now be tested
        automatically by OpenStack testing frameworks%'
   or hist_message like '%Published edit on patch set%'
   or hist_message like '%could not be merged due to a path conflict.%'
   or hist_message like '%add a review comment with%'
   or hist_message like '%This patchset was cherry picked to branch%'
   or hist_message like '%Topic changed from%'
   or hist_message like
